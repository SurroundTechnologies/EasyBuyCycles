...
CREATE OR REPLACE VIEW "VW_Customer_AllDetails"
    ...
    -- Aggregate Join to Sub Customers
            ,CASE WHEN "SubCustomers"."SubCustomerCount" > 0 THEN 'TRUE' ELSE 'FALSE' END AS "IsParentCustomer"
            ,CASE WHEN "Customer"."ParentInternalID" IS NULL OR "Customer"."ParentInternalID" = 0 THEN 'FALSE' ELSE 'TRUE' END AS "IsSubCustomer"
    ...
    -- Audit Stamps
        ...
        FROM "Customer"
            ...
            LEFT JOIN "Customer" AS "ParentCustomer"
                ON "ParentCustomer"."InternalID" = "Customer"."ParentInternalID"
            LEFT JOIN "SubCustomers"
                ON "SubCustomers"."ParentInternalID" = "Customer"."InternalID"
            LEFT JOIN "ShippingAddresses"
                ON "ShippingAddresses"."CustomerInternalID" = "Customer"."InternalID"
            LEFT JOIN "Orders"
                ON "Orders"."CustomerInternalID" = "Customer"."InternalID"
            LEFT JOIN "OrderedProducts"
                ON "OrderedProducts"."CustomerInternalID" = "Customer"."InternalID"
;
