...
namespace WPF.OrderManagement.Shared
{
    ...
    public partial class AddressControls : UserControl
    {
        ...
        public static readonly DependencyProperty FullAddressBlockProperty = DependencyProperty.Register("FullAddressBlock", typeof(string), typeof(AddressControls), new PropertyMetadata(null));
