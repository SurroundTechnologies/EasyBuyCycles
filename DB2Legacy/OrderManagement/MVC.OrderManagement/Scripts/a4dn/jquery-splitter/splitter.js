...
(function ($jq) {
    ...
    $jq.fn.splitter = function(args) {
        ...
        return this.each(function() {
            //if ( $jq(this).is('.splitter') ) return;    // already a splitter
            if ($jq(this).attr('data-splitter-initialized')) {
                return;
            }
            ...
            var A = $jq(panes[0]),
                B = $jq(panes[1]); // A = left/top, B = right/bottom
            ...
            $jq.each([A, B], function() {
                ...
                this._init = opts['size' + this._pane] === true ?
                             parseInt($jq.css(this[0], opts.split), 10) :
            ...
            if (opts.dock) {
                ...
                if (opts.dockKey) {
                    $jq('<a title="' + opts.splitbarClass + ' toggle dock"></a>')
                    .attr({
