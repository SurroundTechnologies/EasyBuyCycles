...
namespace WPF.OrderItem
{
	...
	public partial class  OrderItemExpContent : AB_ContentWindowBase
	{
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(OrderItemExpContent), WPF.OrderManagement.Views.Properties.Resources.Culture);
		}
