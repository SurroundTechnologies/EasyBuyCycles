...
namespace WPF.Order
{
	...
	public partial class  OrderExpContent : AB_ContentWindowBase
	{
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(OrderExpContent), WPF.OrderManagement.Views.Properties.Resources.Culture);
		}
