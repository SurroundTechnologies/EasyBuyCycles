...
namespace WPF.Product
{
	...
	public partial class  ProductExpContent : AB_ContentWindowBase
	{
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(ProductExpContent), WPF.OrderManagement.Views.Properties.Resources.Culture);
		}
