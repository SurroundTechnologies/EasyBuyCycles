...
namespace BOS.OrderDataEntity
{
    ...
    public class OrderEntity : AB_BusinessObjectEntityBase
    {
		...
		[Display(Name = "SHIPPINGADDRESSCONTACTFULLNAME", ResourceType = typeof(DescriptionResource))]
		[AB_ReadOnly]
		[DataMember]
		public string ShippingAddressContactFullName
		{
			get => am_GetPropertyValue(ShippingAddressContactFullNameProperty);
			set => am_SetPropertyValue(ShippingAddressContactFullNameProperty, value);
		}
		public static AB_PropertyMetadata<string> ShippingAddressContactFullNameProperty = am_CreatePropertyMetaData<string>(nameof(ShippingAddressContactFullName), DescriptionResource.SHIPPINGADDRESSCONTACTFULLNAME, null);

		[Display(Name = "SHIPPINGADDRESSTELEPHONE", ResourceType = typeof(DescriptionResource))]
		[AB_ReadOnly]
		[DataMember]
		public string ShippingAddressTelephone
		{
			get => am_GetPropertyValue(ShippingAddressTelephoneProperty);
			set => am_SetPropertyValue(ShippingAddressTelephoneProperty, value);
		}
		public static AB_PropertyMetadata<string> ShippingAddressTelephoneProperty = am_CreatePropertyMetaData<string>(nameof(ShippingAddressTelephone), DescriptionResource.SHIPPINGADDRESSTELEPHONE, null);
		...
		{
			get => am_GetPropertyValue(ShippingAddressLineProperty);
			set => am_SetPropertyValue(ShippingAddressLineProperty, value);
		}
		...
		{
			get => am_GetPropertyValue(OrderItemCountProperty);
			set => am_SetPropertyValue(OrderItemCountProperty, value);
		}
		public static AB_PropertyMetadata<int?> OrderItemCountProperty = am_CreatePropertyMetaData<int?>(nameof(OrderItemCount), DescriptionResource.ORDERITEMCOUNT, null);

		[Display(Name = "TOTAL", ResourceType = typeof(DescriptionResource))]
		[AB_ApplyStringFormat("C")]
		[AB_ReadOnly]
		[DataMember]
		public decimal? OrderTotal
		{
			get => am_GetPropertyValue(OrderTotalProperty);
			set => am_SetPropertyValue(OrderTotalProperty, value);
		}
		...
		[Display(Name = "DISCOUNT", ResourceType = typeof(DescriptionResource))]
		[AB_ApplyStringFormat("P")]
		[AB_ReadOnly]
		[DataMember]
		public decimal? OrderDiscount
		{
			get => am_GetPropertyValue(OrderDiscountProperty);
			set => am_SetPropertyValue(OrderDiscountProperty, value);
		}
		...
		[Display(Name = "DISCOUNTEDTOTAL", ResourceType = typeof(DescriptionResource))]
		[AB_ApplyStringFormat("C")]
		[AB_ReadOnly]
		[DataMember]
		public decimal? OrderDiscountedTotal
		{
			get => am_GetPropertyValue(OrderDiscountedTotalProperty);
			set => am_SetPropertyValue(OrderDiscountedTotalProperty, value);
		}
